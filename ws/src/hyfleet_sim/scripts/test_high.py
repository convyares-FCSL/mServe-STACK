#!/usr/bin/env python3
"""Test: HIGH booster boost to target pressure.

Pass: compressor goal SUCCEEDS, high outlet pressure reaches target.
"""
import sys
import rclpy
...
class TestHigh(Node):
    ...
    def run(self) -> bool:
        self.get_logger().info(f'--- test_high: HIGH START → {TARGET_BAR} bar ---')
        ...
        goal.target          = CC.Goal.HIGH_BOOSTER
