...
// {"T":20020,"hb":<count>,"up":<millis>}
// Periodic liveness heartbeat — sent every HEARTBEAT_INTERVAL_MS regardless
// of host activity, so the Pi can tell the board is present and running.
// Distinct from CMD_HEARTBEAT_TIME (11001), which is a motor-stop watchdog.
#define FB_HEARTBEAT 20020
